...
mysql -u root -h $MYSQL_PORT_3306_TCP_ADDR -p$MYSQL_ROOT_PASSWORD -e "CREATE USER 'apel'@'$MYSQL_PORT_3306_TCP_ADDR' IDENTIFIED BY '$MYSQL_APEL_PASSWORD'"

mysql -u root -h $MYSQL_PORT_3306_TCP_ADDR -p$MYSQL_ROOT_PASSWORD -e "GRANT ALL PRIVILEGES ON apel_rest.* TO 'apel'@'$MYSQL_PORT_3306_TCP_ADDR'"
